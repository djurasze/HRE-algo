...
public class ApplicationFailV2Test {
    ...
    public ApplicationFailV2Test(String input, String output, String errorMessage) {
        this.input = input;
        this.output = output;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"example3-fail-input", "example3-fail-output", "Invalid inputs."}, // pairs with more than one value
